...
echo "Inizio dello script di monitoraggio delle prestazioni di livello2"

# Definizione del percorso della cartella di output e creazione della cartella
OUTPUT_DIR="./livello2Full"
mkdir -p $OUTPUT_DIR
...
sudo falco -c falco/falco.yaml -r falco/log_server.yaml -r falco/sense-hat.yaml -b -A -S 400 | node ws/adapterFull.js &
FALCO_PID=$!
